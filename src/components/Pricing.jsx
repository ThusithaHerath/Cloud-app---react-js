    ...
    <div name='pricing' className='w-full text-white my-24'>
        ...
        <div className='max-w-[1240px] mx-auto py-12'>
            <div className='text-center text-slate-300'>
                ...
                <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. In repudiandae veritatis ratione error tenetur, voluptates architecto possimus ad! Omnis minima ea quidem quisquam unde beatae, minus illo et cum vel</p>
            </div>

            <div className='grid md:grid-cols-2'>
              <div className='bg-white text-slate-900 m-4 p-4 rounded-xl shadow-2xl relative'>
              <span className='uppercase px-3 py-1 bg-indigo-200 rounded-2xl text-indigo-900 text-sm'>Standard</span>
                <div>
              ...
              <div className='bg-white text-slate-900 m-4 p-4 rounded-xl shadow-2xl relative'>
              <span className='uppercase px-3 py-1 bg-indigo-200 rounded-2xl text-indigo-900 text-sm'>Premium</span>
                <div>
